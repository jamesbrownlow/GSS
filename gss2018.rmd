...
$H_0$: Opinion on capital punishment  is inependent of gun ownership
...
OWNGUN is categorical, CAPPUN is also cagegorical
...
This raphs shows that people who own a gun are more likely to favor capital punishment
...
The Chi-squared test p-value is 0.0202, Hence we reject the null hypotheses and conclude that gun ownership and capital punishment are not indepedent

The  fisherexact test has a p-value of .01651 hence we rject the null hypothesis, as with the chi-square test, and futhermore the odds ratio says that gun owners are 2.3 times mor likely to favor capital punishment than thos who do not own a gun 
